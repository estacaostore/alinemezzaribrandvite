            ...
            <li>
              <a href="#">
                <div className="relative flex justify-center bg-red-200">
                  ...
                  <div className="absolute bottom-2 flex justify-center w-full">
                    <ul className="flex gap-2">
                      <li className="bg-white text-sm w-7 h-7 flex items-center justify-center rounded-[50%] drop-shadow-sm">
                        P
                      </li>
                      <li className="bg-white text-sm w-7 h-7 flex items-center justify-center rounded-[50%] drop-shadow-sm">
                        M
                ...
                <div className="flex justify-between mt-3">
                  <h3 className="text-sm w-[70%] font-bold">
                    Cropped Paloma Vemelho AMB
                  </h3>
                  <span className="text-sm w-[30%]">R$ 159.90</span>
                </div>
              </a>
            </li>
            <li>
